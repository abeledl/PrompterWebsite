...
class WordsAssemblerManager:
    ...
    def assemble_word(self, word_data: WordData, vertical_offset: float, scale: float, with_material: bool):
        ...
        if with_material:
            ...
            print(word_data.part_of_speech)
...
class MainProgram:
    ...
    def run(self):
        ...
        # Data
        english_paragraph = ("-Captain- Aria drifted through the silence of space, the distant stars her only companions. Her ship, the Aurora, had been -adrift- for days after -a- malfunction left -her- stranded. -As- supplies -dwindled- -hope- seemed a distant memory. Suddenly, her radar pinged a signal She adjusted course, eyes scanning the void. There, a glimmer of metal, a derelict spacecraft. Aria boarded the abandoned ship, finding its crew gone but its systems functional. She repaired her own vessel using salvaged parts. With a renewed sense of purpose, she set a course for home, grateful for the unexpected lifeline amidst the cosmic desolation.")
        spanish_paragraph = ("La-capitana Aria flotaba a-través del silencio del espacio las distantes estrellas sus únicas compañeras Su nave la Aurora había estado a-la-deriva por días después de-una falla dejó ah-ella varada A-medida-que suministros se-agotaban la-esperanza parecía un distante recuerdo De-repente su radar hizo-ping una señal Ella Ajustó el-rumbo ojos escudriñando el vacío Allí un destello de metal una abandonada nave-espacial Aria abordó la abandonada nave encontrando a-su tripulación desaparecida pero sus sistemas funcionales Ella Reparó su propia nave usando recuperadas partes Con un renovado sentido de propósito Ella puso un curso a casa agradecida por el inesperado salvavidas en-medio de-la cósmica desolación")

        phonetic_paragraph = ("ˈkæptən ˈɛəriə ˈdrɪftɪd θru ðə ˈsaɪləns əv speɪs, ðə ˈdɪstənt stɑrz hɜr ˈoʊnli kəmˈpænjənz. hɜr ʃɪp, ði ɔˈrɔrə, hæd bɪn əˈdrɪft fɔr deɪz ˈæftər ə ˌmælfʌŋkʃən lɛft hɜr ˈstrændɪd. æz səˈplaɪz ˈdwɪndəld, hoʊp simd ə ˈdɪstənt ˈmɛməri. ˈsʌdənli, hɜr ˈreɪdɑr pɪŋd a ˈsɪgnəl ʃi əˈʤʌstɪd kɔrs, aɪz ˈskænɪŋ ðə vɔɪd. ðɛr, ə ˈglɪmər əv ˈmɛtəl a ˈdɛrəˌlɪkt ˈspeɪsˌkræft ˈɛəriə ˈbɔrdɪd ði əˈbændənd ʃɪp, ˈfaɪndɪŋ ɪts kru gɔn bət ɪts ˈsɪstəmz ˈfʌŋkʃənəl. ʃi rɪˈpɛrd hɜr oʊn ˈvɛsəl ˈjuzɪŋ ˈsælvɪʤd pɑrts. wɪð ə rɪˈnud sɛns əv ˈpɜrpəs, ʃi sɛt ə kɔrs fɔr hoʊm, ˈgreɪtfəl fɔr ði ˌʌnɪkˈspɛktɪd ˈlaɪfˌlaɪn əˈmɪdst ðə ˈkɑzmɪk ˌdɛzəˈleɪʃən.")
        ...
        print (tags)
        start_times_array = [0.56, 1.20, 1.84, 2.40, 2.72, 2.96, 3.44, 3.68, 5.04, 5.28, 5.84, 6.32, 6.64, 7.12, 9.09, 9.40, 10.04, 10.37, 11.48, 11.64, 11.88, 12.37, 12.61, 13.64, 13.96, 14.13, 14.92, 15.24, 15.56, 17.59, 17.91, 18.39, 19.43, 19.83, 20.31, 20.47, 21.03, 22.55, 23.19, 23.51, 23.99, 25.03, 25.27, 27.89, 28.21, 28.86, 30.05, 30.54, 31.02, 31.18, 33.87, 34.51, 34.75, 35.23, 35.55, 37.07, 37.39, 38.03, 39.47, 40.03, 40.67, 40.91, 41.71, 43.27, 43.59, 44.08, 44.55, 45.20, 45.52, 45.84, 46.55, 48.88, 49.20, 49.84, 50.08, 50.40, 51.27, 51.99, 52.94, 54.78, 55.02, 55.18, 55.98, 56.38, 56.62, 58.30, 58.54, 58.86, 59.02, 59.50, 59.74, 61.45, 62.09, 62.33, 62.80, 63.92, 64.97, 65.53, 65.77, 66.64]
